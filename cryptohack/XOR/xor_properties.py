...
key2 = pwn.xor(bytes.fromhex(key1), bytes.fromhex(key1_xor_key2)).hex()
key2_xor_key3 = 'c1545756687e7573db23aa1c3452a098b71a7fbf0fddddde5fc1'

key3 = pwn.xor(bytes.fromhex(key2), bytes.fromhex(key2_xor_key3)).hex()
flag_xor_key1_xor_key2_xor_key3 = '04ee9855208a2cd59091d04767ae47963170d1660df7f56f5faf'

flag_xor_key1_xor_key2 = pwn.xor(bytes.fromhex(key3), bytes.fromhex(flag_xor_key1_xor_key2_xor_key3)).hex()

flag_xor_key1 = pwn.xor(bytes.fromhex(key2), bytes.fromhex(flag_xor_key1_xor_key2)).hex()

flag = pwn.xor(bytes.fromhex(key1), bytes.fromhex(flag_xor_key1)).hex()

print('Flag is: ' + bytes.fromhex(flag).decode('utf-8'))